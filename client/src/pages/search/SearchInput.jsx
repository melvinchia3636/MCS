      ...
      {mode === 0 ? (
        <div className="h-full flex-grow w-full flex flex-col justify-center gap-4">
          ...
          <div className="shadow-md p-6 rounded-md text-xl overflow-hidden flex items-center justify-center w-full gap-2 bg-white dark:bg-zinc-600 transition-all duration-500">
            ...
            <input onChange={(e) => setQuery(e.target.value)} onEnter={gotoSearchResult} onKeyDown={handleKeyDown} type="text" placeholder="Type your keyword here..." className="w-full tracking-wide text-slate-700 dark:text-white duration-500 transition-all focus:outline-none bg-transparent" />
          </div>
